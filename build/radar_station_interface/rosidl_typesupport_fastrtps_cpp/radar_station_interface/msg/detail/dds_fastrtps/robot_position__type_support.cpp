...
#include "radar_station_interface/msg/detail/robot_position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = radar_station_interface::msg::RobotPosition;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const radar_station_interface::msg::RobotPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_station_interface::msg::RobotPosition *>(
    untyped_ros_message);
...
{
  return &radar_station_interface::msg::typesupport_fastrtps_cpp::_RobotPosition__handle;
}
