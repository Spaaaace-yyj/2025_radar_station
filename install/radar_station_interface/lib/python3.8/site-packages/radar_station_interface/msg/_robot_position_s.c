...
bool radar_station_interface__msg__robot_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("radar_station_interface.msg._robot_position.RobotPosition", full_classname_dest, 57) == 0);
  }
  radar_station_interface__msg__RobotPosition * ros_message = _ros_message;
  {  // x
...
PyObject * radar_station_interface__msg__robot_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("radar_station_interface.msg._robot_position");
